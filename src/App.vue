...
const data = reactive({
  ...
  items: [
    { description: "Frontend", quantity: 23, rate: 50, amount: 1150 },
    { description: "Backend", quantity: 40, rate: 50, amount: 2000 },
    { description: "Devops", quantity: 10, rate: 150, amount: 1500 },
  ],
...
<template>
  ...
  >
    ...
    <div class="mt-20">
      ...
      <button
        class="ml-5 mt-5 bg-green-600 hover:bg-green-700 text-white font-bold py-2 px-4 rounded"
